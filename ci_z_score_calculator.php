...
Version: 1.0.0
Author: Z-Score Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Z-Score Calculator by www.calculator.io";

function display_calcio_ci_z_score_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_z_score_calculator', 'display_calcio_ci_z_score_calculator' );